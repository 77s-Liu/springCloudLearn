...
function(a, b, c, d) {
        ...
        if (b) {
            ...
            a.each(b,function(b, e) {
                ...
                if (d.options.showCheckbox) {
                 ...
                 f.append(d.options.enableLinks ? a(d.template.link).attr("href", e.href).append(e.text) : e.text).attr({"data-id":e.id,"data-url":e.url}).addClass(e.sign?"active":""),
    ...
    g.prototype.buildStyle = function() {
        ...
        a += "}",
        this.options.onhoverColor && (a += ".node-" + this.elementId + ":not(.node-disabled):hover{background-color:" + this.options.onhoverColor + ";color:#000;}"),
        this.css + a
    },
